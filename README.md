...
## Instructions
To view the battery percentage, simply open the HTML file on a device with a battery. The battery percentage, liquid battery level, and battery status message will update in real-time. Be sure to deactivate any program that prevents the website from reading your computer battery information such as AdGuard and other similar apps.
